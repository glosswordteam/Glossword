...
$ar_settings = array( 'format' => 'xml', 'source-direct' => 0, 'source-localfile' => 1, 'source-remotefile' => 0,
	'input' => '' 
);
...
{
	$this->oOutput->append_html_title( $this->oTkit->_( 1181 ).': '.$this->oTkit->_( 1077 ) );
	$this->oTpl->addVal( 'v:h1', $this->oTkit->_( 1181 ).': '.$this->oTkit->_( 1077 ) );
}
