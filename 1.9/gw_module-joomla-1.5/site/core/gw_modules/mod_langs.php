...
class gw_mod_langs extends site_prepend
{
	/* */
	...
	public function get_actions()
	{
		...
		if ( $this->oSess->is( 'sys-settings' ) )
		{
			...
			$ar_ctrl[] = $this->oHtmlAdm->a_href(
				...
				array( 'title' => $this->oTkit->_( 1001 ).': '.$this->oTkit->_( 1181 ) ),
				$this->oTkit->_( 1001 )
			);
			$oHref->set( 'a', 'manage' );
			$ar_ctrl[] = $this->oHtmlAdm->a_href(
			...
			$ar_ctrl[] = $this->oHtmlAdm->a_href(
				array( $this->V->file_index, '#area' => $oHref->get() ),
				array( 'title' => $this->oTkit->_( 1077 ).': '.$this->oTkit->_( 1181 ) ),
				$this->oTkit->_( 1077 )
			);
			$oHref->set( 'a', 'export' );
			$ar_ctrl[] = $this->oHtmlAdm->a_href(
				array( $this->V->file_index, '#area' => $oHref->get() ),
				array( 'title' => $this->oTkit->_( 1079 ).': '.$this->oTkit->_( 1181 ) ),
				$this->oTkit->_( 1079 )
			);
			/* */
			$oHref->set( 't', 'tvs' );
