...
ALTER TABLE `%s` CHANGE `term_1` `term_1` VARCHAR(16) BINARY NOT NULL, CHANGE `term_2` `term_2` VARCHAR(16) BINARY NOT NULL, CHANGE `term_3` `term_3` VARCHAR(16) BINARY NOT NULL;
