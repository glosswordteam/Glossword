...
if (!defined('IN_GW'))
{
	die('<!-- $Id: users_browse.inc.php 396 2008-04-06 11:08:15Z yrtimd $ -->');
}
...
else
{
	...
	foreach($arSql as $k => $arV)
	{
		...
		$href = $this->sys['page_admin'].'?'.GW_TARGET.'='.GW_T_USERS .'&'.  GW_ACTION.'='.GW_A_EDIT . '&tid='. $arV['id_user'];
		...
		$this->str .= '<td class="xt" style="text-align:center">['. $this->oHtml->a($href, $this->oL->m('3_edit')) . ']</td>';
		$this->str .= '</tr>';
	}
	$this->str .= '</tbody>';
}
