...
if (!defined('IN_GW'))
{
	die('<!-- $Id: dicts_add.inc.php 396 2008-04-06 11:08:15Z yrtimd $ -->');
}
...
if ($this->gw_this['vars']['post'] == '')
{
	...
	$vars['tablename']  = strtolower($this->sys['tbl_prefix'].kMakeUid('x', 8));
...
#$this->sys['isDebugQ'] = 1;
		...
		$q['dict_uri']      = $q['title'];
		$q['date_created']  = $q['date_modified'] = $this->sys['time_now_gmt_unix'];
