		...
		switch ($this->gw_this['vars']['w1'])
		{
			case 'primary':
				...
				$str_form .= '<tr>'.
							...
							'<div class="gray">/'.$this->sys['path_addon'].'/<span id="component-name-1">'.$this->oL->m('1331').'</span>/<span id="component-name-2">*</span>_admin.php</div></td>'.
							'</tr>';
			...
			case 'secondary':
				...
				$str_form .= '<tr>'.
							...
							'<td class="'.$v_class_2.'">' . $ar_broken_msg['icon'] . $oForm->field('input', 'arPost[icon]', $vars['icon']) .
							'</td>'.
							'</tr>';
				$str_js .= '
