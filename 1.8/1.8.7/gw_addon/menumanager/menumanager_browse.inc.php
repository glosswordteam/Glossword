...
$this->str .= '<th>' . $this->oL->m('1357') . '</th>';
$this->str .= '<th style="width:15%">' . $this->oL->m('1358') . '</th>';
...
#	$this->str .= '</td>';
	$this->str .= '<td class="xt center">[';
	$this->str .= $this->oHtml->a($href_edit_cm.'&w1=primary&tid='.$arV[0]['id_component'], $this->oL->m('3_edit'));
	$this->str .= '] [';
	$this->str .= ($is_up ? $this->oHtml->a($href_edit_cm.'&w2=up&w1=primary&tid='.$arV[0]['id_component'], $this->oL->m('3_up')) : $this->oL->m('3_up') );
	$this->str .= '] [';
	$this->str .= ($is_down ?$this->oHtml->a($href_edit_cm.'&w2=down&w1=primary&tid='.$arV[0]['id_component'], $this->oL->m('3_down')) : $this->oL->m('3_down') );
	$this->str .= ']</td>';
	$this->str .= '</tr>';
	...
	for (; list($k2, $arV2) = each($arV);)
	{
		...
		$this->str .= '] [';
		$this->str .= ($is_up ? $this->oHtml->a($href_edit_cm.'&w3='.$arV[0]['id_component'].'&w2=up&w1=secondary&tid='.$arV2['id'], $this->oL->m('3_up')) : $this->oL->m('3_up') );
		$this->str .= '] [';
		$this->str .= ($is_down ? $this->oHtml->a($href_edit_cm.'&w3='.$arV[0]['id_component'].'&w2=down&w1=secondary&tid='.$arV2['id'], $this->oL->m('3_down')) : $this->oL->m('3_down') );
		$this->str .= ']</td>';
		$this->str .= '</tr>';
		$int_secondary++;
	}
