...
if (!defined('IN_GW'))
{
	die('<!-- $Id: custom-pages_admin.php 395 2008-04-06 10:20:18Z yrtimd $ -->');
}
/* */
...
#		$fieldname = $this->component;
		...
		for (; list($elK, $arV) = each($vars['page']);)
		{
			...
			$str_form .= '<fieldset class="admform"><legend style="direction:'.$this->sys['css_align_numbers'].';unicode-bidi:bidi-override">&#160;';
