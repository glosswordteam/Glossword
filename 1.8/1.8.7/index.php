<?php
/**
 *  $Id: index.php 414 2008-04-10 20:17:36Z yrtimd $
 */
/**
...
$oHtml->setVar('mod_rewrite_index', 'index.xhtml');
...
{
	$sys['GW_REQUEST_URI'] = str_replace('%252F', '%2F', $sys['GW_REQUEST_URI']);
...
$gw_this['vars'] = $oGlobals->register(array(
	...
	GW_A_SEARCH,'arPost','strict','visualtheme','uid',
...
#$oGlobals->do_numeric_zero($gw_this['vars']['uid']);
...
{
	if (file_exists('gw_install/install.php'))
	{
		gwtk_header($sys['server_proto'].$sys['server_host'].$sys['server_dir'].'/gw_install/install.php?a=novar');
	}
