 ...
 * 
 * $Id: class.gw_htmlforms.php 408 2008-04-08 08:32:12Z yrtimd $
 */
...
#		$tmp['strform'] .= '<div><span class="xt">'.$this->oL->m('term').'</span><span class="red">*</span></div>';
		...
		if ($this->Gsys['pages_link_mode'] == GW_PAGE_LINK_URI)
		{
			...
			$tmp['strform'] .= '<img style="vertical-align:middle;padding: 0 5px" id="ci-term-uri" src="'.$this->Gsys['path_img_admin'].'/collapse_off.png" alt="" width="9" height="21" />';
		...
		$tmp['strform'] .= '<img style="vertical-align:middle;padding: 0 5px" id="ci-term-az" src="'.$this->Gsys['path_img_admin'].'/collapse_off.png" alt="" width="9" height="21" />';
