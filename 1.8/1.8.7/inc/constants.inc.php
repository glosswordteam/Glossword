...
// - Is multiple records (possible to split each item with a new line)
// - Is root element (<line><term>..<audio>..<defn>..</line>)
// - column order for CSV-export/import
//   5th column is used for `term_uri` in CSV.
...
$arFields = array(
				...
				6  => array('src',     'textarea', 0,      0,  0, 14),
		);
$intFields = count($arFields);
#				12 => array('audio',   'file',      0,     1,  0, -1),
// --------------------------------------------------------
