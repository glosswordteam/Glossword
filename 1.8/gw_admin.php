...
$sys['filters_output'] = ['gw_text_smooth_light'];
/* --------------------------------------------------------
...
$arReq['dict'] = ['title', 'id_topic', 'uid', 'tablename', 'lang', 'cfg', 'visualtheme'];
$arReq['term'] = ['arPre[term][0][value]'];
$strDictDetails = '';
// --------------------------------------------------------
// Load extensions: 27 aug 2003
// --------------------------------------------------------
$gw_this['vars']['funcnames'][GW_A_UPDATE . GW_T_TERM] = isset($gw_this['vars']['funcnames'][GW_A_UPDATE . GW_T_TERM]) ? $gw_this['vars']['funcnames'][GW_A_UPDATE . GW_T_TERM] : [];
$gw_this['vars']['funcnames'][GW_A_UPDATE . GW_T_DICT] = isset($gw_this['vars']['funcnames'][GW_A_UPDATE . GW_T_DICT]) ? $gw_this['vars']['funcnames'][GW_A_UPDATE . GW_T_DICT] : [];
## --------------------------------------------------------
...
if (is_array($arPre)) {
    ...
    if (isset($arPre[$t]['remove'])) {
        $gw_this['vars'][GW_ACTION] = GW_A_REMOVE;
    }
#	${GW_TARGET} = GW_T_TERM;
}
##
