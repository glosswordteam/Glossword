 ...
 * © 2002-2026 Dmitry N. Shilnikov <team at glossword dot biz>
 * Requires:
 *  - class.ua.php
 *
                ...
                case 2:
                    {
                        ...
                        $n = (strtolower($arParts[0]) == $this->tag_noncached) ? $this->tag_noncached . '::' . $this->namespace_default . '::' . $arParts[1] : $arParts[0] . '::' . $arParts[1];
                    }
                    break;
            }
        }
...
#			prn_r( $strInternal, __LINE__ );
                $tmp['str_i'] = '<?php' . CRLF . '$template_timestamp = ' . strval(time() - 1) . ';' . CRLF . $strInternal . '?>';
