...
/**
 * Build list of dictionaries by average hits.
 *
...
/* Do not cache: current date is used in SQL */
$arSql = $oDb->sqlExec(
    $oSqlQ->getQ('top-dict-hits-avg', $sys['time_now_db'], $sys['time_now_db'], $amount)
);

$sumHits = 0;
$sumAvg = 0;

$arThText = [$oL->m('th_1'), $oL->m('th_3'), $oL->m('th_4')];

/* Set column widths */
$arThWidth = ['', '15%', '15%'];

/* Set column alignment */
$arThAlign = [$sys['css_align_left'], $sys['css_align_right'], $sys['css_align_right']];
