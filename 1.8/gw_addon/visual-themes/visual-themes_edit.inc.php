...
if ($this->gw_this['vars']['post'] == '') {
    ...
    if ($this->gw_this['vars']['w1']) {
        ...
        if ($this->gw_this['vars']['w1'] == 'css') {
            ...
            $arSql = [
                ['settings_key' => 'css_style', 'settings_value' => $this->oFunc->file_get_contents($path_css . '/style.css')],
                ['settings_key' => 'css_print', 'settings_value' => $this->oFunc->file_get_contents($path_css . '/style_print.css')],
            ];
        }
    } else {
