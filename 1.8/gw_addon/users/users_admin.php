...
class gw_addon_users_admin extends gw_addon
{
    ...
    public function __construct()
    {
        ...
        $this->ar_state = ['is_user_add' => 0, 'is_user_edit' => 0, 'is_profile' => $this->sys['is_profile_owner']];
     ...
     */
    public function get_form_user($vars, $runtime = 0, $ar_broken = [], $ar_req = [])
    {
        $str_hidden = '';
        $str_form = '';
        $str_js = '';
        ...
        $oForm->arLtr = [
            'arPost[visualtheme]',
            'arPost[user_settings][locale_name]',
            'arPost[login]',
            'arPost[gmt_offset]',
            'arPost[pass_new]',
            'arPost[pass_confirm]',
