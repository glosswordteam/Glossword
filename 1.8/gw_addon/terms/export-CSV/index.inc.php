 ...
 *
 */
function getFormCsv($vars, $runtime = 0, $arBroken = [], $arReq = [])
{
    ...
    foreach ((is_array($vars) ? $vars : []) as $key => $val) {
        ...
        if (isset($arReq[$key])) {
            $arReqMsg[$key] = ' <span style="color:#E30"><b>*</b></span>';
        }
        if (isset($arBroken[$key])) {
            $arBrokenMsg[$key] = ' <span class="' . $trClass . '" style="color:#E30"><b>' . $oL->m('reason_9') . '</b></span>';
        }
    }
    ## ----------------------------------------------------
