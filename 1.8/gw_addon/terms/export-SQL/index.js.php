...
//    selection();
    ...
    if (gw_getElementById(\'split_list1\').checked)
    {
		...
		gw_getElementById(\'arPost_split2_\').style.color = "#AAA";
...
function setCheckboxesSQL(is_check) {
	...
	var ch5 = gw_getElementById(\'arPost_is_hex_\');	
	...
	ch1.checked = ch2.checked = ch3.checked = ch4.checked = ch5.checked = is_check;
}
checkSplit();
';
$strForm .= '/*]]>*/</script>';
